    ...
    <div class="box-header">
        <div class="game-full-rate">
            ...
            <div class="game-play-views">
                <div class="view">
                    <span class="total">Played:</span>
                    <span class="count"><?php echo \helper\number::convert_vn($game->views); ?></span>
                </div>
                <div class="emojis">
                    <div class="flex-align total-like" id-game="<?php echo $game->id; ?>">
...
<span class="exit-fullscreen hidden" id="_exit_full_screen">
    <svg width="24" height="24" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512.001 512.001" style="enable-background:new 0 0 512.001 512.001;">
        <g>
            <g>
