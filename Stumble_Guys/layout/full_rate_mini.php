            ...
            <div id="full_rate_1" class="full_rate">
                <div class="text-center">
                    <div class="rating_hover rating-element">
                        <div class="rating" id="default-demo" data-id="<?php echo $id ?>" style="cursor: pointer;" data-score="<?php echo $rate['rate_average'] ?>" data-readonly=""></div>
                    </div>
    ...
    <div id="rating">
        <div class="inner-rating" itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating">
            <div id="full_rate_1<?php echo $id ?>" class="full_rate">
                <div class="text-center">
                    <div class="rating_hover rating-element">
                        <div class="rating" id="default-demo" data-id="<?php echo $id ?>" style="cursor: pointer;" data-score="<?php echo $rate['rate_average'] ?>" data-readonly="">
                        </div>
                    </div>
                </div>
            </div>
