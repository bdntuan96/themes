<div class="bread-crumb">
    <div class="container">
        <div class="row">
            <div class="overwrite-breadcumb">
                <div class="d-flex bread-crumb-list">
                    <a href="/" class="bread-crumb-item">
                        <svg width="18" height="18" fill="#fff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            <g>
                                <g>
 ...
 c5.454-2.41,8.973-7.812,8.973-13.774V73.847h74.002v122.276c0,4.237,1.784,8.276,4.916,11.13l40.803,37.18H433.965z" />
                    ...
                    <?php //if ($arr_bread) : 
                    ?>
                    <?php foreach ($arr_bread as $bread) : ?>
                        <?php if ($bread['source'] && $is_home) : ?>
                            <a class="bread-crumb-item bread-after" href="/<?php echo $bread['source']; ?>"><?php echo $bread['name'] ?></a>
                        <?php else : ?>
                            <a class="bread-crumb-item bread-after">
                                <?php echo $bread['name']; ?>
                            </a>
                        <?php endif; ?>
                    <?php endforeach; ?>
                ...
                <?php if ($title) : ?>
                    <h1 class="text-uppercase home-title" style="color:#fff; margin: 12px 0"><?php echo $title; ?></h1>
                <?php endif; ?>
            </div>
        </div>
    </div>
