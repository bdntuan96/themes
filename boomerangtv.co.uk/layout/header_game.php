...
<div class="header-game flex">
    <div class="box-header flex-sb">
        <div class="game-full-rate">
            <?php //echo \helper\themes::get_layout('full_rate_mini', array('id' => $game->id));
            ?>
            <div class="game-play-views">
                <div class="view">
                    <span class="total">Total Plays:</span>
                    <span class="count"><?php echo \helper\number::convert_vn($game->views); ?></span>
                </div>
                <div class="emojis">
                    <div class="total-like" id-game="<?php echo $game->id; ?>">
                        <img class="emojis-img" src="<?php echo "/" . DIR_THEME; ?>rs/imgs/thumbs_up_emoji.png" alt="like" title="like" width="" height="">
    ...
    <div class="header-game-extend">
        ...
        <span class="share-btn" id="share-focus" onclick='showSharingBox()' title="Share">
        ...
        <span class="theatemode" onclick="theaterMode()" title="Theater Mode">
        ...
        <span class="expand-btn" id="expand" title="Full screen">
