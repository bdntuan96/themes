...
// lay 30 con game ra
// nhat random 9 con tu 30 kia ra
$game_all = \helper\game::get_paging($page, 36, $keywords, $type, $display, $is_hot, $is_new, "views", "DESC", NULL, $not_equal);

$ran_key = array_rand($game_all, $num=9);
// $game_all[array_rand($game_all, '9')];
// in($ran_key);die;

// $game_ran = \helper\game::random_game(9, null, $type, $game_all);
// in($game_ran);die;

// $ran = rand(8, $limit - 1);
// if ($_SESSION && $_SESSION['ran'] == $ran) {
//     // cho chạy random mới. chạy ra mà vẫn trùng thì:
//     $rannew = rand(8, $limit - 1);
//     // cho nó vào vòng lặp vô hạn có đk: while ($rannew == $ran) đến khi nào ko trùng thì thôi
//     while ($rannew == $ran) {
//         $rannew = rand(8, $limit - 1);
//     }
//     // gán cho thằng ran bằng rannew(khi đã được kiểm tra là ko trùng)
//     $ran = $rannew;
// }
// // gán lại cho phiên hiện tại bằng ran
// $_SESSION['ran'] = $ran;
// 
// in($ran_key);die;
                    ...
                    <div class="container-play">
                        <div class="row">
                            ...
                            <div class="navplay-list">
                                ...
                                <div>
                                    <?php echo \helper\themes::get_layout('game_item_ajax_play', array('games' => $game_all)) ?>
                                </div>
                            </div>
                        </div>
                    </div>
