...
<?php if ($game->type == 'UNITY'): ?>
    ...
    <html lang="en">
        ...
        <body>  
            ...
            <script>
                var gameInstance = UnityLoader.instantiate("gameContainer", "<?php echo $game->source_file; ?>", {onProgress: UnityProgress56, Module: {onRuntimeInitialized: function () {
                ...
                <?php if ($game->type == 'IFRAME_HTML'): ?> 
                    ...
                    <?php else: ?>
                        ...
                        <div class="before-playing" id="preloading-game">
                            ...
                            <div class="preload-before-playing" onclick="start_game_frame()">
                                <div class="image-thumbnail-playing">
                                    <img width="250" height="250" src="<?php echo \helper\image::get_thumbnail($game->image, 250, 250, 'm'); ?>" />
                                </div>
                    ...
                    <?php else: ?>
                        <div id="ax" style="display: none">
                            <object id="GameEmbedSWF" width="100%" height="100%" data="<?php echo $source; ?>" type="application/x-shockwave-flash">
                                <param name="base" value=""><param name="wmode" value="direct">
                                <param name="movie" value="<?php echo $game->source_file; ?>">
                                <param name="menu" value="false"><param name="allowNetworking" value="internal">
