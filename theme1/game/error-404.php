...
$refe = load_session()->get('error-refe');
$domain_url = \helper\options::options_by_key_type('base_url');
$domain_url = preg_replace('/([\/]+)$/', '', $domain_url);
$thumb = \helper\options::options_by_key_type('logo');
$url = $domain_url . '/error-404';
$meta_description = 'The requested this URL was not found on this server';
...
<html lang="en-US">    
    ...
    <body>
        <main>
            ...
            <p id="errorText">O-o-oh! The requested URL <span style="text-decoration: underline; padding-right: 2px"><?php echo $refe; ?></span>  was not found on this sever</p>
            <a id="errorLink" href="/">Go Back</a>
        </main>
    </main>
</body>
</html>
<?php load_session()->remove('error-refe'); ?>