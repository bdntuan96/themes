...
<div class="header-game">
    <div class="box-header">
        <div class="game-full-rate">
            ...
            <div class="show_game flex center">
                <div class="infor_game flex">
                    <img class="image_game" width="40" height="40" src="<?php echo \helper\image::get_thumbnail($game->image, 40, 40, 'f'); ?>" title="<?php echo $game->name; ?>" alt="<?php echo $game->name; ?>" />
                </div>
                <div class="title_game">
                    <h2 class="font-site text-overflow"><?php echo $game->name; ?></h2>
                </div>
            </div>
