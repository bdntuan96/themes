<?php if ($arr_bread) : ?>
    <ul class="breadcrumb flex center text">
        <li>
            <a class="breadcrumb_name" href="/" title="Home">
        ...
        <?php foreach ($arr_bread as $breadnew) : ?>
            <?php if ($breadnew['source']) : ?>
                <li><a class="breadcrumb_name" href="/<?php echo $breadnew['source']; ?>" title="<?php echo $breadnew['name'] ?>"><?php echo $breadnew['name'] ?></a></li>
            <?php else : ?>
