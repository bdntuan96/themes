    ...
    <div class="tag">
        <ul class="flex center flex-wrap">
            ...
            <?php foreach ($list_cate as $cate) : ?>
                <li class="tag_item">
                    <a href="/posts/<?php echo $cate->slug; ?>" title="<?php echo $cate->name; ?>" class="tag_btn">
                        <?php if ($cate->image) : ?>
                            <span>
                                <img class="icon_tag" src="<?php echo \helper\image::get_thumbnail($cate->image, 20, 20, "m") ?>" width="20" height="20" alt="<?php echo $cate->name; ?>"  title="<?php echo $cate->name; ?>">
                            </span>
                        <?php endif; ?>
            ...
            <?php foreach ($list_tags as $tag) : ?>
                <li class="tag_item">
                    ...
                    <a href="/tag/<?php echo $tag->slug; ?>" title="<?php echo $tag->name; ?>" class="tag_btn">
                        <?php if ($tag->image) : ?>
                            <span>
                                <img class="icon_tag" src="<?php echo \helper\image::get_thumbnail($tag->image, 20, 20, "m") ?>" width="20" height="20" alt="<?php echo $tag->name; ?>"  title="<?php echo $tag->name; ?>">
                            </span>
                        <?php endif; ?>
